...
# source: brain_computer_interface/protocol/mind.proto
...
_CONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='config', full_name='Config.config', index=0,
...
User = _reflection.GeneratedProtocolMessageType('User', (_message.Message,), {
  'DESCRIPTOR' : _USER,
  '__module__' : 'brain_computer_interface.protocol.mind_pb2'
